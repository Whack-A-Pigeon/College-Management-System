...
*/
	private ViewStudentPanel(Student s)
	{
		...
		lblcourse.setBounds(20, 359+150, 291, 48);
		add(lblcourse);
		...
		JLabel coursenamelabel = new JLabel("  "+new courseData().getcoursename(s.getcourseCode()));
		...
		coursenamelabel.setBounds(309, 359+150, 274, 48);
		add(coursenamelabel);
		...
		JLabel semoryearlabel = new JLabel(
				"  " + new courseData().getsemoryear(s.getcourseCode()) + "-" + s.getSemorYear() + " " + " (" + s.getcourseCode() + ")");
