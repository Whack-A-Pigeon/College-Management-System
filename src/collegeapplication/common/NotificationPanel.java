...
public class NotificationPanel extends JPanel {
	...
	public NotificationPanel(StudentMain sm)
	{
		this();
		this.sm=sm;
		addNotification(sm.s.getcourseCode(),sm.s.getSemorYear(),"Student",sm.s.getUserId(),sm.s.getAdmissionDate());
	}
	public NotificationPanel(FacultyMain fm)
	{
		this();
		this.fm=fm;
		addNotification(fm.f.getcourseCode(),fm.f.getSemorYear(),"Faculty",fm.f.getFacultyId()+"",fm.f.getJoinedDate());
		
	}
	public void addNotification(String coursecode,int semoryear,String userprofile,String userid,String joinedtime)
	{
		ArrayList<Notification> list=new NotificationData().getNotifications(coursecode, semoryear,userprofile,joinedtime);
