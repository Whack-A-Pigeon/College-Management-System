...
public class ViewFacultyPanel extends JPanel {
	...
	private ViewFacultyPanel(Faculty f)
	{
		...
		courselbl.setFont(new Font("Segoe UI Historic", Font.PLAIN, 20));
		courselbl.setBorder(new LineBorder(new Color(192, 192, 192)));
		courselbl.setBackground(Color.WHITE);
		courselbl.setBounds(20, 405+150, 291, 48);
		add(courselbl);
		...
		if(f.getcourseCode()==null ||f.getcourseCode().equals("Not Assigned"))
		{
		coursenamelabel.setText("  "+f.getcourseCode());	
		}
		else
		{
		coursenamelabel.setText("  "+f.getcourseName());	
		}
		
		coursenamelabel.setOpaque(true);
		coursenamelabel.setHorizontalAlignment(SwingConstants.LEFT);
		coursenamelabel.setFont(new Font("Segoe UI Historic", Font.BOLD, 20));
		coursenamelabel.setBorder(new LineBorder(new Color(192, 192, 192)));
		coursenamelabel.setBackground(Color.WHITE);
		coursenamelabel.setBounds(309, 405+150, 274, 48);
		add(coursenamelabel);
		...
		{
			semoryearlabel.setText("  "+new courseData().getsemoryear(f.getcourseCode())+"-"+f.getSemorYear()+" "+" ("+f.getcourseCode()+")");
		}
